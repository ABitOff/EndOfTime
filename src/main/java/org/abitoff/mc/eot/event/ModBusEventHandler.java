...
public class ModBusEventHandler
{
	...
	@SubscribeEvent
	public static void onContainerTypeRegistryEvent(final RegistryEvent.Register<ContainerType<?>> e)
	{
		e.getRegistry().register(MutationAcceleratorContainer.getContainerType());
	}
}
